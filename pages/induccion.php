...
<body>
  ...
  <div class="cont-menu active" id="menu">
    ...
    <h1 class="tit1">INDUCCIÓN</h1>
      <a href="./index1.html"><img src="../sources/img/v91_24.png" alt="Logo de la página" class="img1"></a>
  </header>
    <article class="articulo">
        <div class="container">
            <p class="tit2">Aspectos básicos</p>
        </div>
      <div class="container">
        <p class="qs"><br> En esta diapositiva podrás encontrar la diapositiva que se presentó en el auditorio, la cual muestra los aspectos básicos de la media técnica. Por si no lo pudiste entender, acá puedes leer detenidamente.</p>
      </div>
        <div class="container">
          <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726599900/codezero/kxawykvtbilzvsfzgm3e.png" alt=""  class="img4">
        </div>
        <div class="container">
          <p class="tit1"><a href="https://docs.google.com/presentation/d/1cOXzIJ0BvAZ1PiZkBEF1U1B9T2flqKKd/edit#slide=id.p14"> DIAPOSITIVA INDUCCIÓN A LA MEDIA TÉCNICA</p></a>
        </div>
        <div class="container">
          <p class="tit2"><br> Reforcemos tu conocimiento</p>
      </div>
        <div class="container">
            <p class="qs"><br> Ahora, si crees que necesitas un breve repaso de la anterior diapositiva, esta te puede ser de gran ayuda para ello, ya que te ayudará a recordar los aspectos que se vieron en la diapositiva anterior. </p>
        </div><div class="container">
            <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726599900/codezero/kxawykvtbilzvsfzgm3e.png" alt=""  class="img4">
          </div>
          <div class="container">
            <p class="tit1"><a href="https://docs.google.com/presentation/d/1cOXzIJ0BvAZ1PiZkBEF1U1B9T2flqKKd/edit#slide=id.p14"> DIAPOSITIVA PARA REPASO DE MEDIA TÉCNICA </p></a>
          </div>
