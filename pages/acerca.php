...
<body>
  ...
  <div class="cont-menu active" id="menu">
    ...
    <h1 class="acerca1">Acerca De Código Desde 0</h1>
      <a href="./index1.html"><img src="../sources/img/v91_24.png" alt="Logo de la página" class="img1"></a>
  </header>
    <article class="articulo">
      <div class="container">
        <p class="acerca">¡Sea bienvenido a este espacio de nuestro sitio web! <br>

          Código desde cero surgió gracias a que adentramos esto como problemática en nuestro Proyecto Integradores de Aula (PIA). Encabezado por el alumno Sebastián García, seguido de los miembros Juan José Román y Kevin Hernández. <br>
          
          El propósito de este sitio como tal es que sea de ayuda para estudiantes que aspiran a entrar a la media técnica que ofrece la institución junto a la Institución Univeristaria Pascual Bravo.</p>
      </div>
        <div class="container">
          <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726014531/codezero/mz80tfj4ayigdj57j19c.png" alt=""  class="img3">
        </div>
