...
<body>
  <header>
    ...
    <div class="cont-menu active" id="menu">
      <ul>
          <li>ACERCA DE CODIGO DESDE 0</li>
          <li>¿QUIENES SOMOS?</li>
          <li>INDUCCIÓN</li>
          <li>PROGRAMAS</li>
          <li>CURSOS</li>
    ...
    <h1 class="title">CÓDIGO DESDE CER0</h1>
      <img src="../sources/img/v91_24.png" alt="Logo de la página" class="img1">
  </header>
    <nav class="navegador">
          <div class="cuadro">
            <img src="../sources/img/v223_23.png" alt="" width="50" height="40" class="icono">
            <span class="registro1">Registrarse</span>
        </div>
          <div class="cuadro1">
            <img src="../sources/img/v223_20.png" alt="" width="70" height="40" class="icono">
            <span class="registro">Iniciar sesion</span>
      </div>
    </nav>
    <article class="articulo">
        ...
        <div class="container">
          <img src="../sources/img/v920.png" alt="bienvenido :D"  class="img2">
        </div>
    </article>
    <footer>
