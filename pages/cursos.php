...
<body>
    ...
    <h1 class="tit1">CURSOS</h1>
      <a href="./index2.html"><img src="../sources/img/v91_24.png" alt="Logo de la página" class="img1"></a>
  </header>
    <article class="articulo">
        <div class="container">
            <p class="tit2">Curso de Python</p>
        </div>
      <div class="container">
        <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726773761/codezero/dnpapmobcutlpag6lwgz.png" alt="" class="img2">
      </div>
        <div class="container">
          <p class="tit1"><a href="https://github.com/mouredev/Hello-Python">Link directo</p></a>
        </div>
        <div class="container">
          <p class="cursos"><br> En este link podrás encontrar aspectos básicos de Python que te ayudarán a hacer programas sencillamente.</p>
      </div>
      <div class="container">
        <p class="tit2">Curso de HTML5</p>
    </div>
  <div class="container">
    <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726771635/codezero/uxouw31i9oevgby0kubd.png" alt="">
  </div>
    <div class="container">
      <p class="tit1"><a href="https://drive.google.com/drive/folders/0By2pfNu9CViYdTNNTGRIRG10QW8">Link directo</p></a>
    </div>
    <div class="container">
      <p class="cursos"><br>En este link podrás encontrar aspectos básicos de HTML5 que te ayudarán a maquetar tus páginas de una manera correctamente estructurada.</p>
  </div>
  <div class="container">
    <p class="tit2">Curso de C# (C-Sharp)</p>
</div>
<div class="container">
<img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726771635/codezero/qucaeywirckt2euxdbyq.png" alt="">
</div>
<div class="container">
  <p class="tit1"><a href="https://www.youtube.com/playlist?list=PLU8oAlHdN5BmpIQGDSHo5e1r4ZYWQ8m4B">Link directo</p></a>
</div>
<div class="container">
  <p class="cursos"><br>En este link podrás ver una lista de reproducción en Youtube de 127 vídeos, donde paso a paso te explicarán como utilizar el lenguaje de programación C#</p>
</div>
<div class="container">
  <p class="tit2">Cursos variados</p>
</div>
<div class="container">
<img src="https://res.cloudinary.com/djv5yehct/image/upload/v1726771635/codezero/hscjdbhgjzmjdrj1re5m.png" alt="">
</div>
<div class="container">
<p class="tit1"><a href="https://capacitateparaelempleo.org/">Link directo</p></a>
</div>
<div class="container">
<p class="cursos"><br>En esta página no solo encontrarás cursos sobre programación (PHP, Javascript, Sitios web, C#, etc), también podrás encontrar cursos sobre agricultura, construccción, barbería y muchas cosas más, donde se incluye una certificación.</p>
</div>
    </article>
    <footer>
