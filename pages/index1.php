...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap" rel="stylesheet">
    ...
    <title>Inicio - Código Desde Cero</title>
</head>
<body>
  <header>
    ...
    <link rel="shortcut icon" href="https://res.cloudinary.com/djv5yehct/image/upload/v1725564312/codezero/jontkj15pv2hvdfwstzc.png">
      <h1 class="title">CÓDIGO DESDE CER0</h1>
      <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1725564312/codezero/jontkj15pv2hvdfwstzc.png" alt="Logo de la página" class="img1">
  </header>
    <nav class="navegador">
    </div>  
          <div class="cuadro">
            <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1725564312/codezero/xg7srbaf4yirisdvvpji.png" alt="" width="50" height="40" class="icono">
            <span class="registro1"><a href="../pages/index.html">Registrarse</a></span>
        </div>
          <div class="cuadro1">
            <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1724793091/codezero/nnlhledt0uxqu86l7yop.png" alt="" width="70" height="40" class="icono">
            <span class="registro"> <a href="../pages/inicio.html">Iniciar sesion</a></span>
      </div>
    </nav>
    <article class="articulo">
          <p class="bienvenido">Bienvenido! 
            Sientase cómodo y explora diversos códigos</p>
        <div class="container">
          <img src="https://res.cloudinary.com/djv5yehct/image/upload/v1725564313/codezero/gmj3rncb1ppruf0zeaeu.png" alt="bienvenido :D"  class="img2">
        </div>
    </article>
    <footer>
