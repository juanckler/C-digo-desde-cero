...
<head>
    ...
    <title>Olvide mi contraseña - Código Desde Cero</title>
    ...
    <div class="flex flex-col items-center min-h-screen">
        ...
        <div class="text-center mt-8">
            <div class="w-full flex justify-center">
                <img class="content-center size-36" src="https://res.cloudinary.com/djv5yehct/image/upload/v1725389902/codezero/is8hlls4ccklihjgulkj.png" alt="Logo">
            </div>
            <h1 class="text-lg font-bold plaster-regular" >CÓDIGO DESDE CERO</h1>
            <br>
            <h2 class="text-md fira-code-uniquifier text-2xl">¿Problemas Para Iniciar Sesión?</h2>
            <br>
            <p><h1 class="sm:hidden text-md fira-code-uniquifier text-lg ">Ingresa el correo electrónico registrado para enviarte un enlace donde podrás reestablecer tu contraseña</h1></p>
            <p><h1 class="hidden sm:block text-md fira-code-uniquifier text-xl ">Ingresa el correo electrónico registrado para</h1></p>
            <p><h1 class="hidden sm:block text-md fira-code-uniquifier text-xl">enviarte un enlace donde podrás reestablecer tu contraseña</h1></p>
        </div>
        ...
        <form class="mt-8 w-full max-w-xs space-y-4">
            ...
            <button type="submit" class="w-full py-2 bg-teal-600 hover:bg-teal-500 text-white font-bold rounded-xl"><a href="../pages/inicio.html">Volver al inicio de sesión</a></button>
        </form>

        <!-- ¿Tienes una cuenta? -->
        <div class="mt-4">
            <p>Crea una cuenta <a href="../pages/index.html" class="text-teal-400">Crear Cuenta</a></p>
        </div>
